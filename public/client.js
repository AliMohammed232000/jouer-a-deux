const socket = io({ transports : ['websocket'] }); //https://stackoverflow.com/questions/44628363/socket-io-access-control-allow-origin-error 'http://localhost:3000', { transports : ['websocket'] }
